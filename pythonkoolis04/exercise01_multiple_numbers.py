...
if __name__ == '__main__':
    number_list = generate_number_list(smallest=1, largest=10)
    print(number_list)
    multiplier = ask_user_int("Please insert multiplier:")
    multiplied_list = multiply_list(number_list, multiplier)
    show_result(number_list, multiplier, multiplied_list)
